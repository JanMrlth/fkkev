...
class User(db.Model):
    ...
    persontype = db.Column(db.Integer,default=0) #1 = Legal Person , 2 = Natural Person
    ...
    road = db.Column(db.String(400))
    town = db.Column(db.String(400))
    postcode = db.Column(db.Integer,nullable=False)
    phone = db.Column(db.VARCHAR(400))
    mobile = db.Column(db.VARCHAR(400),nullable=False)
...
class Bankdetails(db.Model):
    ...
    iban = db.Column(db.VARCHAR(500), unique=True,nullable=False)
    iban_visible = db.Column(db.String(34),nullable=False) 
    bic = db.Column(db.VARCHAR(400),nullable=False) #Autogenerated from IBAN(https://openiban.com/validate/<IBAN>?getBIC=true)(https://openiban.com/validate/DE89370400440532013000?getBIC=true)
