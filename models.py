...
class User(db.Model):
    ...
    bankdetails = relationship("Bankdetails", uselist=False, back_populates="User",post_update=True)
...
class Bankdetails(db.Model):
    ...
    bic = db.Column(db.String(15)) #Autogenerated from IBAN(https://openiban.com/validate/<IBAN>?getBIC=true)(https://openiban.com/validate/DE89370400440532013000?getBIC=true)
